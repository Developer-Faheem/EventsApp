      ...
      child: Scaffold(
        body: Stack(
          children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/pictures/img.png"), // Replace with your image path
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
            ...
            Positioned(
              top: height*0.285, // Set the top value to the height of the image container
              bottom: 0,
              left: 0,
              right: 0,
              child: Container(
                decoration: const BoxDecoration(
                  color: kPrimary,
                  borderRadius: BorderRadius.only(topLeft: Radius.circular(20),topRight: Radius.circular(5))
                ),
                    ...
                    Row(children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(  
                                    ...
                                    image: AssetImage('assets/pictures/avatar2.png'), // Replace with your image path
                                    fit: BoxFit.cover,
                                  ), 
                                  ),
                                ),
                     ...
                     SizedBox(height: height*0.025,),
                      ...
                      Text(
                       ...
                       SizedBox(height: height*0.012,),
                                  ...
                                  Text(  "Nestled in the heart of Montréal, the Greenwood Summerhouse restaurant is a hidden gem.Its serene ambiance and lush surroundings create an enchanting dining experience.Upon entering, you’re greeted by a symphony of colors and fragrances.Read More"
                                   ,style: GoogleFonts.montserrat(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Container(),
                                MainButton(buttonText: 'See Events'),
